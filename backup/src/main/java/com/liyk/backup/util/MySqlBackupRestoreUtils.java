...
public class MySqlBackupRestoreUtils {
    ...
    public static boolean backup(String host, String userName, String password, String backupFolderPath, String fileName, String database) throws Exception {
        ...
        System.out.println(getCommand(stringBuilder.toString()));
    ...
    public static void main(String[] args) throws Exception {
        ...
        String backupFolderPath = "E:/liyk/";
        String fileName = "mango.sql";
        boolean res = backup(host, userName, password, backupFolderPath, fileName, database);
        System.out.println("备份成功" + res);
