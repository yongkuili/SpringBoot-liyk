package com.liyk.backup.controller;

import com.liyk.backup.datasource.BackupDataSourceProperties;
import com.liyk.backup.service.MysqlBackupService;
import com.liyk.backup.util.BackupConstants;
import com.liyk.backup.util.HttpResult;
import com.liyk.tools.common.util.FileUtils;
 ...
 * @author liyongkui
 * @version 1.0
 * @description: 系统数据备份还原
 * @date 2022/8/24 09:34
 */
...
public class MySqlBackupController {
    ...
    public HttpResult findBackupRecords() {
        ...
        backupRecords.sort((o1, o2) -> BackupConstants.DEFAULT_BACKUP_NAME.equalsIgnoreCase(o1.get("name")) ? -1 : BackupConstants.DEFAULT_BACKUP_NAME.equalsIgnoreCase(o2.get("name")) ? 1 : o2.get("name").compareTo(o1.get("name")));
