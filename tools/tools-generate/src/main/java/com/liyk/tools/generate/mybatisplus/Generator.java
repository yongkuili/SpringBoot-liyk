package com.liyk.tools.generate.mybatisplus;
...
public class Generator {
    // 数据库连接字段配置
    private static final String JDBC_URL = "jdbc:mysql://39.96.45.15:3306/mango?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSWORD = "123456Aa?";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.liyk.apps";
    private static final String MODULE_NAME = "sys";

    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"sys_config"/*,"sys_dept","sys_dict","sys_log","sys_login_log","sys_menu","sys_role","sys_role_dept","sys_role_menu","sys_user","sys_user_role"*/};
    ...
    public static void main(String[] args) {
        //获取当前工程路径(这里无需修改)
        String projectPath = System.getProperty("user.dir")+"/tools/generate";
        //1.数据库配置(设置数据源)
       ...
       //4.模板配置
        fastAutoGenerator.templateConfig(
                templateConfigBuilder -> templateConfigBuilder
                        ...
                        .mapperXml("/templates/mapper.xml")   // 设置mapperXml模板路径
